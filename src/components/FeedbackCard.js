  ...
  <Card className={classes.root}>
    <CardContent>
      <Grid container wrap="nowrap" spacing={2}>
        <Grid item>
          <Avatar alt="Anonymous User" src={imgLink} className={classes.avatar} />
        </Grid>
        <Grid item xs zeroMinWidth>
          <Typography className={classes.title}>{props.fb.title}</Typography>
          <Typography className={classes.user}>Anonymous User</Typography>
          <Typography className={classes.description}>{props.fb.description}</Typography>
          <Typography className={classes.date}>{props.fb.date}</Typography>
        </Grid>
      </Grid>
    </CardContent>
  </Card>
